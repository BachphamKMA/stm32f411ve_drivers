...
drivers/Src/%.o drivers/Src/%.su: ../drivers/Src/%.c drivers/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32F411VETx -DSTM32 -DSTM32F4 -c -I../Inc -I"D:/Users/Bach/STM32CubeIDE/workspace_1.9.0/stm32f4xx_drivers/drivers/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"

clean: clean-drivers-2f-Src

clean-drivers-2f-Src:
	-$(RM) ./drivers/Src/stm32f411xx_gpio_driver.d ./drivers/Src/stm32f411xx_gpio_driver.o ./drivers/Src/stm32f411xx_gpio_driver.su ./drivers/Src/stm32f411xx_i2c_driver.d ./drivers/Src/stm32f411xx_i2c_driver.o ./drivers/Src/stm32f411xx_i2c_driver.su ./drivers/Src/stm32f411xx_rcc_driver.d ./drivers/Src/stm32f411xx_rcc_driver.o ./drivers/Src/stm32f411xx_rcc_driver.su ./drivers/Src/stm32f411xx_spi_driver.d ./drivers/Src/stm32f411xx_spi_driver.o ./drivers/Src/stm32f411xx_spi_driver.su ./drivers/Src/stm32f411xx_usart_driver.d ./drivers/Src/stm32f411xx_usart_driver.o ./drivers/Src/stm32f411xx_usart_driver.su
